...
public class Calib3d {
    ...
    public static double calibrateCamera(List<Mat> objectPoints, List<Mat> imagePoints, Size imageSize, Mat cameraMatrix, Mat distCoeffs, List<Mat> rvecs, List<Mat> tvecs, int flags, TermCriteria criteria)
    {
        ...
        Mat rvecs_mat = new Mat(h, w, CvType.CV_8UC1, y_plane);
        Mat tvecs_mat = new Mat(h, w, CvType.CV_8UC1, y_plane);
    ...
    {
        Mat rotations_mat = new Mat(h, w, CvType.CV_8UC1, y_plane);
        Mat translations_mat = new Mat(h, w, CvType.CV_8UC1, y_plane);
        Mat normals_mat = new Mat(h, w, CvType.CV_8UC1, y_plane);
